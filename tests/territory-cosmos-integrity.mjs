...
assert(!generator.includes('tile_w=')&&!generator.includes('variants=[]'),'Hearthlands texture generator still tiles/repeats the flatmap');
assert(generator.includes('used exactly once')&&generator.includes('continent_w=1680'),'Hearthlands texture is not built as one coherent planetary continent');
assert(generator.includes('unique_crops')&&generator.includes('Family Home'),'Hearthlands texture does not guard against repeated central-house imagery');
...
assert(js.includes('elapsed>280')&&js.includes('elapsed>1580'),'Hearthlands entry is not using the faster twinkling-cosmos handoff');
assert(js.includes('8+30*p')&&js.includes('1+7.4*p'),'cosmic tunnel does not accelerate strongly enough');
