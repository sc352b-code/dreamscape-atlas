...
// Fresnel-style atmosphere around the actual sphere.
...
// Texture centre (longitude 0) is intentionally Hearthlands. These are
// world-model coordinates, not screen hotspots: labels follow the rotating sphere.
const territories = [
...
function updateDescent(now) {
  ...
  // Hearthlands is authored at texture centre, so this orientation puts the real
  // geographic point directly under the camera before the map opens.
