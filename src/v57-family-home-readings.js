...
const INTERPRETIVE_PROFILES={
  ...
  dog:{
    ...
    constellations:[
      {name:'Companionship woven into family life',confidence:'MEDIUM-HIGH',evidence:'Known dogs repeatedly appear with reference corpus, Mum, family, fields, houses and other animals as energetic members of a shared relational world.',possibility:'The dog may gather embodied loyalty and social belonging—connection expressed through proximity, movement and participation.',counterpoint:'These appearances often directly reflect affection for real dogs and ordinary family continuity.',dreamIds:['Harmony Underneath','The Trained Rest Ritual','New dream 517']},
